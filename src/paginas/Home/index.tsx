...
const Home = () => {
    ...
    const { data: lancamentos } = useQuery(['lancamentosKey'], ()=> getLivrosDestaque('lancamentos'))
    const { data: maisVendidos } = useQuery(['maisVendidosKey'], ()=> getLivrosDestaque('mais-vendidos'))
